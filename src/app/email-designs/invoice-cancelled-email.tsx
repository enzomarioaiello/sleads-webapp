...
const translations = {
  en: {
    preview: "Invoice cancelled from Sleads",
    greeting: "Hi",
    subject: "Invoice Cancelled - Sleads",
    intro:
      "We wanted to inform you that the invoice below has been cancelled. No payment is required for this invoice.",
    ...
    portalDescription:
      "You can view this cancelled invoice and all your invoices directly through your portal.",
    viewInPortal: "View in Portal",
    footer:
      "If you have any questions about this cancellation, please don't hesitate to reach out to us.",
    copyright: "© {year} Sleads. All rights reserved.",
  },
  nl: {
    preview: "Factuur geannuleerd van Sleads",
    greeting: "Hallo",
    subject: "Factuur Geannuleerd - Sleads",
    intro:
      "We willen u informeren dat de onderstaande factuur is geannuleerd. Er is geen betaling vereist voor deze factuur.",
    ...
    portalDescription:
      "U kunt deze geannuleerde factuur en al uw facturen bekijken via uw portaal.",
    viewInPortal: "Bekijk in Portaal",
    footer:
      "Als u vragen heeft over deze annulering, aarzel dan niet om contact met ons op te nemen.",
        ...
        <Body className="bg-sleads-dark my-auto mx-auto font-sans text-white">
          <Container className="my-[40px] mx-auto max-w-[600px]">
            ...
            <Section className="rounded-t-2xl overflow-hidden bg-sleads-card border border-white/10 border-b-0 relative">
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-linear-to-r from-transparent via-[#6B7280] to-transparent opacity-75" />
              <div className="h-2 w-full bg-[#6B7280] opacity-20" />
              <div className="h-32 w-full bg-[linear-gradient(180deg,rgba(107,114,128,0.15)_0%,rgba(15,23,42,0)_100%)]" />
              <div className="mt-[-80px] text-center mb-[40px]">
                <div className="relative inline-block">
                  <div className="absolute inset-0 bg-gray-500 blur-[30px] opacity-30 rounded-full" />
                  <Img
                    src="https://sleads.nl/images/logo.png"
                    width="64"
                    height="64"
                    alt="Sleads"
                    className="relative rounded-2xl shadow-[0_0_40px_-10px_rgba(107,114,128,0.6)] border border-white/10"
                  />
                </div>
              </div>
            </Section>
            ...
            <Section className="bg-sleads-card px-10 pb-10 rounded-b-2xl border border-t-0 border-white/10 mt-[-20px]">
              ...
              <Section className="bg-white/5 rounded-xl border border-white/10 p-6 mb-6">
                <Text className="text-xs font-bold text-[#6B7280] uppercase tracking-wider mb-4">
                  {t.invoiceDetails}
                </Text>
              ...
              <Section className="bg-white/5 rounded-xl border border-white/10 p-6 mb-6">
                ...
                <Row className="pt-2 border-t border-white/10">
                  ...
                  <Column className="w-[25%]" align="right">
                    <Text className="text-[#6B7280] text-[18px] font-bold m-0">
              ...
              {/* Portal Information */}
              <Section className="bg-linear-to-r from-[#6B7280]/10 to-transparent rounded-xl border border-[#6B7280]/20 p-6 mb-6">
                ...
                <Section className="text-center">
                  <Link
                    className="bg-[#6B7280] text-white rounded-full text-[14px] font-bold no-underline text-center px-6 py-3 inline-block shadow-[0_4px_20px_-5px_rgba(107,114,128,0.5)] border border-white/10"
                    href={portalUrl}
                  >
                    {t.viewInPortal}
                  </Link>
...
export function renderInvoiceCancelledEmail(props: InvoiceCancelledEmailProps) {
  return render(<InvoiceCancelledEmail {...props} />);
}

export default InvoiceCancelledEmail;
